...
type Params struct {
	...
	EpochSwitchNewStakingTxMap       []uint64
}
...
func init() {
	...
	ChainTestParam = Params{
		...
		EpochSwitchNewStakingTxMap: TestnetEpochSwitchNewStakingTxMap,
	}
	// END TESTNET
	// FOR MAINNET
	...
	ChainMainParam = Params{
		...
		EpochSwitchNewStakingTxMap: MainnetEpochSwitchNewStakingTxMap,
	}
	if IsTestNet {
